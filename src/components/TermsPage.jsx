export default function TermsPage() {
  return (
    <div className="min-h-screen bg-deepnavy px-4 py-8 text-gray-200">
      <div className="mx-auto max-w-2xl">
        <a href="/" className="mb-6 inline-block text-sm text-cyanbright">
          ← 地球儀にもどる
        </a>
        ...
        <section className="mb-10">
          <h2 className="mb-3 text-lg font-bold text-cyanbright">利用規約</h2>

          <h3 className="mb-1 mt-4 font-semibold text-white">1. 本規約について</h3>
          <p className="text-sm leading-relaxed">
            本規約は、「世界のポーズ地球儀」(以下「本サービス」)の利用条件を定めるものです。本サービスを利用した時点で、本規約に同意したものとみなします。
          </p>

          <h3 className="mb-1 mt-4 font-semibold text-white">2. サービス内容</h3>
          <p className="text-sm leading-relaxed">
            本サービスは、利用者が撮影した写真と選択した国情報を投稿し、地球儀上にピンとして表示するサービスです。投稿された写真は、本サービスにアクセスできる全ての利用者に公開されます。アカウント登録は不要です。
          </p>

          <h3 className="mb-1 mt-4 font-semibold text-white">3. 未成年者の利用について</h3>
          <p className="text-sm leading-relaxed">
            未成年の方が投稿する場合は、あらかじめ保護者等の同意を得たうえでご利用ください。
          </p>

          <h3 className="mb-1 mt-4 font-semibold text-white">4. 禁止事項</h3>
          ...
          <h3 className="mb-1 mt-4 font-semibold text-white">5. 投稿の削除</h3>
          <p className="text-sm leading-relaxed">
            投稿者本人は、投稿から一定時間内であれば自分の投稿を削除できます。また、他の利用者による通報や運営による判断により、禁止事項に該当すると判断された投稿は予告なく削除される場合があります。
          </p>

          <h3 className="mb-1 mt-4 font-semibold text-white">6. 免責事項</h3>
          <p className="text-sm leading-relaxed">
            本サービスの利用により生じた損害について、運営者は故意または重過失がある場合を除き責任を負いません。本サービスは予告なく内容の変更、中断、終了する場合があります。
          </p>

          <h3 className="mb-1 mt-4 font-semibold text-white">7. 規約の変更</h3>
          <p className="text-sm leading-relaxed">
        ...
        <section>
          <h2 className="mb-3 text-lg font-bold text-cyanbright">プライバシーポリシー</h2>

          <h3 className="mb-1 mt-4 font-semibold text-white">1. 取得する情報</h3>
          <ul className="ml-5 list-disc text-sm leading-relaxed">
            <li>投稿された写真画像</li>
            <li>選択された国の情報</li>
            <li>投稿日時</li>
          ...
          <h3 className="mb-1 mt-4 font-semibold text-white">2. 利用目的</h3>
          <p className="text-sm leading-relaxed">
            取得した情報は、本サービスの提供(地球儀への表示、投稿の管理、不適切投稿への対応)のためにのみ利用します。
          </p>

          <h3 className="mb-1 mt-4 font-semibold text-white">3. 第三者への提供</h3>
          <p className="text-sm leading-relaxed">
          ...
          <h3 className="mb-1 mt-4 font-semibold text-white">4. 保存期間・削除</h3>
          <p className="text-sm leading-relaxed">
          ...
          <h3 className="mb-1 mt-4 font-semibold text-white">5. お問い合わせ</h3>
          <p className="text-sm leading-relaxed">
